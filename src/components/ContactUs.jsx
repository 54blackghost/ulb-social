...
const ContactUs = () => {
    ...
    //fonction du site web2forms.com qui permet de valider les emails par API
    const onSubmit = async (event) =>{
       ...
       event.preventDefault();
        ...
        formData.append("access_key", "6789b1d4-bd14-40b3-a440-1df736697520");
  ...
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title title='Reach out to us' desc='From strategy to execute, we craft
