...
const Footer = ({theme}) => {
  return (
    <motion.div
        ...
        viewport={{once:true}} 
    className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-40 sm:mt-40 px-4
    sm:px-10 lg:px-24 xl:px-40'>
      ...
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        ...
        className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
            ...
            <p className='max-w-md'>From strategy to execute, we craft digital
        ...
        viewport={{once:true}} 
        className='texte-gray-600 dark:text-gray-400'>
            <h3 className='font-semibold'>Subcribe to our 
                newsletter
            </h3>
            ...
            <div className='flex gap-2 text-sm'>
                ...
                dark:text-gra-200 bg-transparent border
      ...
      justifiy-center sm:justify-between gap-4 flex-wrap'>
        <p>Copyright 2025 by Ulrichleblack - All Right Reserved.</p>
